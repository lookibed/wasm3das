...
at 0.56x of the C wasm3 on execution and equals it end to end, process
start included; the `exe` tier below runs the same corpus at 0.8x of C on
execution (`docs/native-build.md`, sections 1 and 7). It gets
