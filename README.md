...
at 0.5x of the C wasm3 on execution and equals it end to end, process
start included, and beats C on coremark's own score; the `exe` tier below
runs the same corpus at 0.8x of C on execution and 1.3x end to end
(`docs/native-build.md`, sections 1 and 7). It gets
