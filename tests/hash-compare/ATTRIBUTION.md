# hash-compare fixture

Hash loop module built from Spider's own C sources (AGPL-3.0).
...
`tests/manual/hash-compare/generated/`. Spider itself is licensed under AGPL-3.0;
